    ...
    return <div className="AccountCreator">
      <div className="so-back AccountCreator__section">
        <div className="so-chunk">
          ...
          <p>These keypairs can be used on the Triam network where one is required. For example, it can be used as an account master key, account signer, and/or as a triam-core node key.</p>
      ...
      <div className="so-back AccountCreator__section">
        <div className="so-chunk">
          ...
          <p>The friendbot is a horizon API endpoint that will fund an account with 10,000 RIA on the test network.</p>
